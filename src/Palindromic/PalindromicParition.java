...
public class PalindromicParition {
    ...
    int findPalindromicPartionCount(String str)
    {
        return this.findMPPCutsRecursive(str, 0, str.length()-1);
    }
    ...
    public int findMPPCutsTopdown(String st) {
    ...
    public int findMPPCutsDP(String st) {
